...
import { MovieAddHistory, getMovieById } from "../services/movie.api";
import TrailerModal from "../../home/components/TrailerModal";
import { useSelector } from "react-redux";
import MovieModal from "../components/MovieModal";
import { addFavorite, removeFavorite } from "../../home/services/favorite.api";
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                {movieId && (
                  <button
                    onClick={() => {
                      (setShowMovie(true), MovieAddHistory(movie._id));
                    }}
                    className="px-8 py-3 bg-[#e50914] text-white rounded-lg font-semibold flex items-center gap-2 hover:bg-[#f40612] transition-all transform hover:scale-105 shadow-lg"
                  >
                    <FiPlay size={20} />
